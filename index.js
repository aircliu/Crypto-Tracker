            ...
            plugins: {
                legend: {
                    ...
                    onClick: function (event, legendItem, context) {
                        ...
                        legendItem.text = `Next ${nextCoin.charAt(0).toUpperCase() + nextCoin.slice(1)} price`; // add "Next" before the coin name
...
document.getElementById('next-coin-button').addEventListener('click', () => {
  currentCoinIndex = (currentCoinIndex + 1) % coins.length;
